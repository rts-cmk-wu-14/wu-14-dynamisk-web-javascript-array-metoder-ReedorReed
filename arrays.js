document.addEventListener('DOMContentLoaded', function () {
	...
	let doesItIncludeTrixie = dogsArray.includes('Trixie');

	console.log('Opgave 3a: ', doesItIncludeTrixie);
	...
	let doesItIncludeBaxter = dogsArray.includes('Baxter');

	console.log('Opgave 3b: ', doesItIncludeBaxter);
	...
	const findCatBagheera = catsArray.find((cat) => cat === 'Bagheera');

	console.log('Opgave 4a: ', findCatBagheera);

	// Opgave 4b
	// Check om der i catsArray er en kat som hedder "Salem".
	// Udskriv katten i konsollen hvis den findes og ellers "undefined".
	// console.log("Opgave 4b", ...)
	const findCatSalem = catsArray.find((cat) => cat === 'Salem');

	console.log('Opgave 4a: ', findCatSalem);
	...
	const numbersArrayTimesThree = numbersArray.map((num) => num * 3);
	console.log('Opgave 5: ', numbersArrayTimesThree);
	...
	const removePolly = dogsArray.splice(3, 1)
